...
class ModelCheckpointAtEpochEnd(pl.callbacks.ModelCheckpoint):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super().__init__(save_last=save_last, save_top_k=save_top_k, dirpath=dirpath, monitor=monitor, mode=mode, **kwargs)
    ...
    def on_train_epoch_end(self, trainer: pl.Trainer, pl_module: pl.LightningModule) -> None:
        ...
        checkpoint_name = f'epoch_{trainer.current_epoch}.ckpt'
