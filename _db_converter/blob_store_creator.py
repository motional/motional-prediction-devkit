...
from _db_converter.blob_store.blob_store import BlobStore
from _db_converter.blob_store.cache_store import CacheStore
from _db_converter.blob_store.http_store import HttpStore
from _db_converter.blob_store.local_store import LocalStore
from _db_converter.blob_store.s3_store import S3Store
...
class BlobStoreCreator:
    ...
    @classmethod
    def create_s3(cls, s3_root_url, verbose):
        store = S3Store(s3_root_url, "", show_progress=verbose)
        return store
